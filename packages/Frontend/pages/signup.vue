...
<template>
  <div
    ...
    <UForm :schema="schema" :state="state"
      class="w-6/12 h-full py-10 flex flex-col  items-center float-right bg-white rounded-l-[80px]" @submit="onSubmit">
      ...
      <UButton type="submit"
        class="flex justify-center items-center bg-gradient-to-r from-electric-violet-500 to-electric-violet-400 text-white w-1/2 h-14 rounded-md text-lg font-semibold">
        Sign up
      </UButton>
